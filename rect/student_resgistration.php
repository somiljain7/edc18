        ...
        <div class="container">
            ...
            <form class="form-horizontal needs-validation" role="form" enctype="multipart/form-data" method="POST">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <h2 class="mt-3 text-center" style="padding:30px;"> Recruitment Form 2018
                            <hr> </h2>
                ...
                <div class="row">
                    <div class="col-md-3 field-label-responsive">
                        <label for="branch">Department and Year</label>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                                <div class="input-group-addon" style="width: 2.6rem"><i class="fa fa-university"></i></div>
                                <input type="text" name="branch" class="form-control" id="email" placeholder="Department and Year" required autofocus>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                ...
                <div class="row mt-4">
                    <div class="col-md-3 field-label-responsive">
                        <label for="ques5">
                  Work Sample ( Blog link/Github Link/Porfolio)
                  </label>
                    </div>
                    <div class="col-md-6">
                        <label for="ques5">Answer:</label>
